  ...
  theme: {
    extend: {
      colors: {
        ...
        // Semantic color tokens for fitness app
        intensity: {
          low: "#10b981",      // Green for low intensity
        ...
        workout: {
          ...
          flexibility: "#10b981", // Green for flexibility/yoga
          sports: "#a855f7"      // Purple for sports
        }
      },
      borderRadius: {
        lg: "var(--radius)",
